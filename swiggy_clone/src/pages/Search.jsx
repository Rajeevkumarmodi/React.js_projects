...
import SearchResultResCard from "../components/SearchResultResCard";
  ...
  return (
    <>
      <div className="sticky top-20 left-0 pb-2 pt-12 bg-white z-2">
        <div className="w-4/5 sm:w-3/4 h-12 xl:w-[860px] mx-auto border border-[#282c3f4d] border-b border-black rounded-md">
          <form
            onSubmit={(e) => {
              e.preventDefault();
            }}
